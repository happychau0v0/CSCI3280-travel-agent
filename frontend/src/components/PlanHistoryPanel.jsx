 ...
 * and lets the user re-load any past plan via a LOAD button. The panel
 * is also a drop zone for .json files exported from another browser /
 * device, so plans become portable without a backend.
 *
 * Props:
